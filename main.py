    ...
    def generate_pdf(self) -> None:
        ...
        def add_contato(subcategory: str, use_link: bool = False):
            if subcategory in self.data['Contato']:
                if os.path.exists(os.path.join('Images', f'{subcategory}.png')):
                    pdf.image(os.path.join('Images', f'{subcategory}.png'), x=5, y=pdf.get_y() + 2.5, h=5)  # y centraliza com o texto
                if use_link:
                    _font_style: str = 'U'
